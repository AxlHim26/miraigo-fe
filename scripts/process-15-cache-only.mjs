...
const FALLBACK = {
  ...
  "to discern (e.g. right from wrong), to discriminate, to distinguish, to know (manners, one's place, etc.), to understand, to bear in mind":
    "phân biệt (đúng sai), hiểu, ghi nhớ",
  "speech, tongue, talk, eloquence, dialect, brogue, accent, bento, Japanese box lunch, petal, valve, Oversight Department, division of the daijokan under the ritsuryō system responsible for controlling central and provincial governmental offices":
    "diễn thuyết, lưỡi, nói, hùng biện, phương ngữ, giọng, hộp cơm bento, cánh hoa, van",
  "strong person, person putting on a brave front, bamboo tube with holes drilled in it (used as a stand for kitchen utensils, fans, etc.), checks, plaid, checked pattern":
    "người mạnh, người tỏ ra dũng cảm, ô caro",
  "discernment, clear analysis, clear expression, distinguished speech":
    "sáng suốt, phân tích rõ, diễn đạt rõ",
